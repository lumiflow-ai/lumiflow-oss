...
export type AnyRecipeStepInput = BaseRecipeStepInput &
  (RecipeStepConstantInput | RecipeStepArtifactInput | RecipeStepMetricInput);

export type AnyRecipeStepOutput = BaseRecipeStepOutput &
  (RecipeStepArtifactOutput | RecipeStepSnapshotOutput | RecipeStepMetricOutput);
...
export type ChartSeries = {
  ...
  colors?: (CSSColor | [PrimitiveValue, CSSColor][]) | undefined;
  legends?: (string | [PrimitiveValue, string][]) | undefined;
...
export type ChartValueAccumulationStrategy =
  (typeof ChartValueAccumulationStrategy)[keyof typeof ChartValueAccumulationStrategy];

export const ChartValueNormalizationStrategy = {
  none: "none",
  ratio: "ratio",
} as const;
export type ChartValueNormalizationStrategy =
  (typeof ChartValueNormalizationStrategy)[keyof typeof ChartValueNormalizationStrategy];
...
export type MetricDefinition = {
  ...
  displayValues?: [PrimitiveValue, string][] | undefined;
...
export type PartialMetricDefinition = {
  ...
  displayValues?: ([PrimitiveValue, string][] | null) | undefined;
